...
<body>
	...
	<header>
		...
		<li class="active"><a href="paket.php">GUIDE</a></li>
...
<body>
	...
	<section>
		<div class="row">
			<div class="column">
				<div class="card">
					<img src="pemanduang5.jpeg"style="width:150px;height:auto;padding-top:10px">
					<h1>Ahmad Thoyib</h1>
					<p class="title">Pemandu Gunung & Porter Gunung Gede Pangrango</p>
					<p>Include</p>
					<p>Homestay dan makan</p>
				...
				<a href="https://bit.ly/2QW36cZ"><p><button>Contack</button></p>
			</div>
		</div>
	</a>
			<div class="column">
				<div class="card">
					<img src="pemandungang1.jpeg"style="width:150px;height:auto;padding-top:10px">
					<h1>Ang Asep Sherpa</h1>
					<p class="title">Pemandu Gunung & Porter Gunung Gede Pangrango</p>
					<p>Include</p>
					<p>Homestay dan makan</p>
				<a href="login.php"><i class="fas fa-user-circle"></i>
		...
		<div class="column">
				<div class="card">
					<img src="pemanduang.jpeg"style="width:150px;height:auto;padding-top:10px">
					<h1>Bani Pangrango</h1>
					<p class="title">Pemandu Gunung & Porter Gunung Gede Pangrango</p>
					<p>Include</p>
					<p>Homestay dan makan</p>
				<a href="login.php"><i class="fas fa-user-circle"></i>
				...
				<a href="https://www.facebook.com/bookingtnggp/"><i class="fab fa-facebook"></i></a>
				<a href="https://twitter.com/tngedepangrango"><i class="fab fa-twitter"></i></a></a>
				<p><button><a href="https://bit.ly/2QW36cZ">Contack</button></p>
			</div>
		</div>
	</a>
		<div class="column">
				<div class="card">
					<img src="pemanduang6.jpeg"style="width:150px;height:auto;padding-top:10px">
					<h1>Reynaly Rimbawan</h1>
					<p class="title">Pemandu Gunung & Porter Gunung Gede Pangrango</p>
					<p>Include</p>
					<p>Homestay dan makan</p>
				<a href="login.php"><i class="fas fa-user-circle"></i>
				...
				<a href="https://www.facebook.com/bookingtnggp/"><i class="fab fa-facebook"></i></a>
				<a href="https://twitter.com/tngedepangrango"><i class="fab fa-twitter"></i></a></a>
				<a href="https://bit.ly/2QW36cZ"><p><button>Contack</button></p></a>
			</div>
		</div>
		</section>
